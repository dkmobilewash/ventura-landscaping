...
const faqs = [
  ...
  { q: 'Is critter control part of your maintenance?', a: 'It can be. Our crews monitor for animal and pest activity on every visit and address problems early. Call (805) 833-0167 to learn more.' },
];
  ...
  return (
    <>
      ...
      <CTABanner
        ...
        subtext="Dealing with gophers, grubs, or nightly digging? Call (805) 833-0167 and we’ll help you take your yard back."
      />
    </>
  );
}
